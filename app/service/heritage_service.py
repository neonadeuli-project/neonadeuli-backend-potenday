...
class HeritageService:
    ...
    async def get_heritages(
        ...
        try:
            offset = (page - 1) * limit
            heritages, total_count = (
                await self.heritage_repository.search_heritages(
                    limit,
                    offset,
                    user_latitude,
                    user_longitude,
        ...
        heritage_list = [
            HeritageListResponse(
                ...
                heritage_type=(
                    heritage.heritage_types.name
                    if heritage.heritage_types
                    else "Unknown"
                ),
